...
const FloorHeatingWidgetBath: React.FC = () => {
  const { on, temp, currentTemp, loading, setTemp, setOn } = useFloorHeating("bath");
  ...
  return (
    <div className="bg-[#22243c] rounded-xl p-6 flex flex-col items-center mb-8 w-full">
      <h4 className="text-lg font-semibold mb-3">Тёплый пол Ванная</h4>
...
export default FloorHeatingWidgetBath;
